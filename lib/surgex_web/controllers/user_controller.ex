defmodule SurgexWeb.UserController do
  ...
  alias Surgex.Accounts.{ActivationToken, RecoverToken, User}

  action_fallback SurgexWeb.FallbackController
  # Requires to be an admin!
  plug(Surgex.Auth.Plug.AdminUser, [] when action not in [:recover, :activate])
