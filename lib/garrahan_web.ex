defmodule GarrahanWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: GarrahanWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/garrahan_web/templates",
        namespace: GarrahanWeb
      ...
      import GarrahanWeb.ErrorHelpers
      import GarrahanWeb.Gettext
      alias GarrahanWeb.Router.Helpers, as: Routes
    end
  end
