...
const initialState = {
  authUser: null,
  token: null,
  surgeriesPhotosPath: "/uploads/surgeries/photos" // @TODO Parse it from server-side!
};
...
const getters = {
  ...
  getSurgeriesPhotoUrl: (state) => (photo) => `${state.surgeriesPhotosPath}/${photo.md5}-${photo.name}`
};
